...
FINAL_IMAGE=${DISTDIR}/Exercise1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Exercise1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=ATmega328PB
# ------------------------------------------------------------------------------------
# Rules for buildStep: compile
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Exercise1.o: Exercise1.c  .generated_files/flags/default/f620c166380c765973b5f3aa38d57ad246dd68bf .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
...
${OBJECTDIR}/Exercise1.o: Exercise1.c  .generated_files/flags/default/d8190cba5ffbc4ef7842587e47df45958727d767 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Exercise1.o.d 
	@${RM} ${OBJECTDIR}/Exercise1.o 
...
${DISTDIR}/Exercise1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}\\avr-objcopy -O ihex "${DISTDIR}/Exercise1.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}" "${DISTDIR}/Exercise1.X.${IMAGE_TYPE}.hex"
endif
