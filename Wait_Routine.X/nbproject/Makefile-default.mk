...
FINAL_IMAGE=${DISTDIR}/Wait_Routine.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Wait_Routine.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/Function.obj: Function.asm  nbproject/Makefile-${CND_CONF}.mk 
	...
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Function.obj 
	${MP_AS}  -fI -W+ie ${PACK_ASSEMBLER_OPTIONS} -d ${DISTDIR}/Wait_Routine.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  -S ${DISTDIR}/Wait_Routine.X.${IMAGE_TYPE}.tmp  -o ${DISTDIR}/Wait_Routine.X.${IMAGE_TYPE}.hex  -m ${DISTDIR}/Wait_Routine.X.${IMAGE_TYPE}.map  -l ${DISTDIR}/Wait_Routine.X.${IMAGE_TYPE}.lss Function.asm
endif

# ------------------------------------------------------------------------------------
# Rules for buildStep: link
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/Wait_Routine.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
